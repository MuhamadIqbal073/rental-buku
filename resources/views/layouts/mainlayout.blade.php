...
<head>
    ...
    <title>Rental Buku | Dashboard @yield('title')</title>
...
<body>
    ...
    <div class="main d-flexflex-column justify-content-between">
        <nav class="navbar navbar-dark navbar-expand-lg bg-dark">
            <div class="container-fluid">
              <a class="navbar-brand" href="#" ><i class="bi bi-diamond"></i>  Rental Buku</a>
          ...
          <div class="body-content h-100">
            <div class="row g-0 h-100">
                <div class="sidebar col-lg-2 collapse d-lg-block" id="navbarTogglerDemo03">
                        ...
                        <a href="/logout"><i class="bi bi-box-arrow-in-left"></i>  Logout</a>
